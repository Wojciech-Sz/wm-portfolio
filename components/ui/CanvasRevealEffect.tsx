    ...
    >
      <div className="size-full">
        <DotMatrix
          ...
          opacities={
            opacities ?? [
              0.3, 0.3, 0.3, 0.5, 0.5, 0.5, 0.8, 0.8, 0.8,
              1,
            ]
          }
          shader={`
              float animation_speed_factor = ${animationSpeed.toFixed(
                1
              )};
...
const DotMatrix: React.FC<DotMatrixProps> = ({
  colors = [[0, 0, 0]],
  opacities = [
    0.04, 0.04, 0.04, 0.04, 0.04, 0.08, 0.08, 0.08, 0.08,
    0.14,
  ],
  totalSize = 4,
  dotSize = 2,
  ...
  const getUniforms = () => {
    ...
    for (const uniformName in uniforms) {
      ...
      switch (uniform.type) {
        ...
        default:
          console.error(
            `Invalid uniform type for '${uniformName}'.`
          );
          break;
      }
    }
